...
import EchartsMapScatter from '@/echarts-setting/echarts-map-scatter/index'
import DataSourceSetting from '@/common-component/map-scatter-setting/data-source-setting'

export default {
  name: 'MapScatterSetting',
  data() {
    return {
      select: '配置',
    }
