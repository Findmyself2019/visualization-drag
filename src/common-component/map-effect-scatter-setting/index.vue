...
import EchartsMapEffectScatter from '@/echarts-setting/echarts-map-effect-scatter/index'
import { mapActions } from 'vuex'
import DataSourceSetting from '@/common-component/map-effect-scatter-setting/data-source-setting'

export default {
  name: 'MapEffectScatterSetting',
  data() {
    return {
      select: '配置',
    }
